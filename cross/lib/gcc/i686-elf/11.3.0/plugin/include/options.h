...
enum opt_code
{
  ...
  OPT_masm_ = 1702,                          /* -masm= */
  OPT_mavx = 1703,                           /* -mavx */
  OPT_mavx2 = 1704,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1705,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1706,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1707,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1708,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1709,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1710,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1711,                      /* -mavx512bw */
  OPT_mavx512cd = 1712,                      /* -mavx512cd */
  OPT_mavx512dq = 1713,                      /* -mavx512dq */
  OPT_mavx512er = 1714,                      /* -mavx512er */
  OPT_mavx512f = 1715,                       /* -mavx512f */
  OPT_mavx512ifma = 1716,                    /* -mavx512ifma */
  OPT_mavx512pf = 1717,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1718,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1719,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1720,                      /* -mavx512vl */
  OPT_mavx512vnni = 1721,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1722,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1723,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1724,                       /* -mavxvnni */
  OPT_mbmi = 1725,                           /* -mbmi */
  OPT_mbmi2 = 1726,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1727,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1728,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1729,                    /* -mcet-switch */
  OPT_mcld = 1730,                           /* -mcld */
  OPT_mcldemote = 1731,                      /* -mcldemote */
  OPT_mclflushopt = 1732,                    /* -mclflushopt */
  OPT_mclwb = 1733,                          /* -mclwb */
  OPT_mclzero = 1734,                        /* -mclzero */
  OPT_mcmodel_ = 1735,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1736, */                    /* -mcpu= */
  OPT_mcrc32 = 1737,                         /* -mcrc32 */
  OPT_mcx16 = 1738,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1739,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1740,            /* -mdump-tune-features */
  OPT_menqcmd = 1741,                        /* -menqcmd */
  OPT_mf16c = 1742,                          /* -mf16c */
  OPT_mfancy_math_387 = 1743,                /* -mfancy-math-387 */
  OPT_mfentry = 1744,                        /* -mfentry */
  OPT_mfentry_name_ = 1745,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1746,               /* -mfentry-section= */
  OPT_mfma = 1747,                           /* -mfma */
  OPT_mfma4 = 1748,                          /* -mfma4 */
  OPT_mforce_drap = 1749,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1750,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1751,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1752,                       /* -mfpmath= */
  OPT_mfsgsbase = 1753,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1754,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1755, */              /* -mfused-madd */
  OPT_mfxsr = 1756,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1757,             /* -mgeneral-regs-only */
  OPT_mgfni = 1758,                          /* -mgfni */
  OPT_mhard_float = 1759,                    /* -mhard-float */
  OPT_mharden_sls_ = 1760,                   /* -mharden-sls= */
  OPT_mhle = 1761,                           /* -mhle */
  OPT_mhreset = 1762,                        /* -mhreset */
  OPT_miamcu = 1763,                         /* -miamcu */
  OPT_mieee_fp = 1764,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1765,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1766,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1767,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1768,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1769,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1770,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1771,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1772, */            /* -mintel-syntax */
  OPT_mkl = 1773,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1774,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1775,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1776,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1777,                /* -mlong-double-80 */
  OPT_mlwp = 1778,                           /* -mlwp */
  OPT_mlzcnt = 1779,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1780,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1781,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1782,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1783,                  /* -mmitigate-rop */
  OPT_mmmx = 1784,                           /* -mmmx */
  OPT_mmovbe = 1785,                         /* -mmovbe */
  OPT_mmovdir64b = 1786,                     /* -mmovdir64b */
  OPT_mmovdiri = 1787,                       /* -mmovdiri */
  OPT_mmpx = 1788,                           /* -mmpx */
  OPT_mms_bitfields = 1789,                  /* -mms-bitfields */
  OPT_mmwait = 1790,                         /* -mmwait */
  OPT_mmwaitx = 1791,                        /* -mmwaitx */
  OPT_mneeded = 1792,                        /* -mneeded */
  OPT_mno_align_stringops = 1793,            /* -mno-align-stringops */
  OPT_mno_default = 1794,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1795,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1796,                  /* -mno-push-args */
  OPT_mno_red_zone = 1797,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1798,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1799,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1800,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1801,                          /* -mpc32 */
  OPT_mpc64 = 1802,                          /* -mpc64 */
  OPT_mpc80 = 1803,                          /* -mpc80 */
  OPT_mpclmul = 1804,                        /* -mpclmul */
  OPT_mpcommit = 1805,                       /* -mpcommit */
  OPT_mpconfig = 1806,                       /* -mpconfig */
  OPT_mpku = 1807,                           /* -mpku */
  OPT_mpopcnt = 1808,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1809, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1810,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1811,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1812,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1813,                        /* -mprfchw */
  OPT_mptwrite = 1814,                       /* -mptwrite */
  OPT_mpush_args = 1815,                     /* -mpush-args */
  OPT_mrdpid = 1816,                         /* -mrdpid */
  OPT_mrdrnd = 1817,                         /* -mrdrnd */
  OPT_mrdseed = 1818,                        /* -mrdseed */
  OPT_mrecip = 1819,                         /* -mrecip */
  OPT_mrecip_ = 1820,                        /* -mrecip= */
  OPT_mrecord_mcount = 1821,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1822,                 /* -mrecord-return */
  OPT_mred_zone = 1823,                      /* -mred-zone */
  OPT_mregparm_ = 1824,                      /* -mregparm= */
  OPT_mrtd = 1825,                           /* -mrtd */
  OPT_mrtm = 1826,                           /* -mrtm */
  OPT_msahf = 1827,                          /* -msahf */
  OPT_mserialize = 1828,                     /* -mserialize */
  OPT_msgx = 1829,                           /* -msgx */
  OPT_msha = 1830,                           /* -msha */
  OPT_mshstk = 1831,                         /* -mshstk */
  OPT_mskip_rax_setup = 1832,                /* -mskip-rax-setup */
  OPT_msoft_float = 1833,                    /* -msoft-float */
  OPT_msse = 1834,                           /* -msse */
  OPT_msse2 = 1835,                          /* -msse2 */
  OPT_msse2avx = 1836,                       /* -msse2avx */
  OPT_msse3 = 1837,                          /* -msse3 */
  OPT_msse4 = 1838,                          /* -msse4 */
  OPT_msse4_1 = 1839,                        /* -msse4.1 */
  OPT_msse4_2 = 1840,                        /* -msse4.2 */
  OPT_msse4a = 1841,                         /* -msse4a */
  /* OPT_msse5 = 1842, */                    /* -msse5 */
  OPT_msseregparm = 1843,                    /* -msseregparm */
  OPT_mssse3 = 1844,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1845,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1846, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1847,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1848, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1849,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1850,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1851,            /* -mstringop-strategy= */
  OPT_mstv = 1852,                           /* -mstv */
  OPT_mtbm = 1853,                           /* -mtbm */
  OPT_mtls_dialect_ = 1854,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1855,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1856,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1857,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1858,                         /* -mtune= */
  OPT_muintr = 1859,                         /* -muintr */
  OPT_mvaes = 1860,                          /* -mvaes */
  OPT_mveclibabi_ = 1861,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1862,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1863,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1864,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1865,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1866,                      /* -mwbnoinvd */
  OPT_mwidekl = 1867,                        /* -mwidekl */
  OPT_mx32 = 1868,                           /* -mx32 */
  OPT_mxop = 1869,                           /* -mxop */
  OPT_mxsave = 1870,                         /* -mxsave */
  OPT_mxsavec = 1871,                        /* -mxsavec */
  OPT_mxsaveopt = 1872,                      /* -mxsaveopt */
  OPT_mxsaves = 1873,                        /* -mxsaves */
  OPT_n = 1874,                              /* -n */
  OPT_name_sort = 1875,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1876,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1877,              /* -no-integrated-cpp */
  OPT_no_pie = 1878,                         /* -no-pie */
  ...
  OPT_pie = 1894,                            /* -pie */
  OPT_pipe = 1895,                           /* -pipe */
  OPT_print_file_name_ = 1896,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1897,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1898,          /* -print-multi-directory */
  OPT_print_multi_lib = 1899,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1900,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1901,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1902,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1903,               /* -print-prog-name= */
  OPT_print_search_dirs = 1904,              /* -print-search-dirs */
  OPT_print_sysroot = 1905,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1906,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1907,                    /* -print-value */
  OPT_quiet = 1908,                          /* -quiet */
  OPT_r = 1909,                              /* -r */
  OPT_remap = 1910,                          /* -remap */
  OPT_reverse_sort = 1911,                   /* -reverse-sort */
  OPT_s = 1912,                              /* -s */
  OPT_save_temps = 1913,                     /* -save-temps */
  OPT_save_temps_ = 1914,                    /* -save-temps= */
  OPT_shared = 1915,                         /* -shared */
  OPT_shared_libgcc = 1916,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1917,               /* -shared-libphobos */
  OPT_size_sort = 1918,                      /* -size-sort */
  /* OPT_specs = 1919, */                    /* -specs */
  OPT_specs_ = 1920,                         /* -specs= */
  OPT_static = 1921,                         /* -static */
  OPT_static_libasan = 1922,                 /* -static-libasan */
  OPT_static_libgcc = 1923,                  /* -static-libgcc */
  OPT_static_libgfortran = 1924,             /* -static-libgfortran */
  OPT_static_libgo = 1925,                   /* -static-libgo */
  OPT_static_libhwasan = 1926,               /* -static-libhwasan */
  OPT_static_liblsan = 1927,                 /* -static-liblsan */
  OPT_static_libmpx = 1928,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1929,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1930,               /* -static-libphobos */
  OPT_static_libstdc__ = 1931,               /* -static-libstdc++ */
  OPT_static_libtsan = 1932,                 /* -static-libtsan */
  OPT_static_libubsan = 1933,                /* -static-libubsan */
  OPT_static_pie = 1934,                     /* -static-pie */
  /* OPT_std_c__03 = 1935, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1936, */                /* -std=c++0x */
  OPT_std_c__11 = 1937,                      /* -std=c++11 */
  OPT_std_c__14 = 1938,                      /* -std=c++14 */
  OPT_std_c__17 = 1939,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1940, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1941, */                /* -std=c++1z */
  OPT_std_c__20 = 1942,                      /* -std=c++20 */
  OPT_std_c__23 = 1943,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1944, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1945, */                /* -std=c++2b */
  ...
  OPT_std_gnu__23 = 1970,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1971, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1972, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1973,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1974,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1975,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1976, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1977, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1978,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1979, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1980,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1981,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1982, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1983, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1984,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1985, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1986, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1987, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1988, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1989, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1990,                     /* -std=legacy */
  OPT_stdlib_ = 1991,                        /* -stdlib= */
  OPT_symbol_ = 1992,                        /* -symbol= */
  OPT_symbolic = 1993,                       /* -symbolic */
  OPT_t = 1994,                              /* -t */
  OPT_time = 1995,                           /* -time */
  OPT_time_ = 1996,                          /* -time= */
  OPT_traditional = 1997,                    /* -traditional */
  OPT_traditional_cpp = 1998,                /* -traditional-cpp */
  OPT_tree_stats = 1999,                     /* -tree-stats */
  OPT_trigraphs = 2000,                      /* -trigraphs */
  OPT_type_stats = 2001,                     /* -type-stats */
  OPT_u = 2002,                              /* -u */
  OPT_undef = 2003,                          /* -undef */
  OPT_v = 2004,                              /* -v */
  OPT_version = 2005,                        /* -version */
  OPT_w = 2006,                              /* -w */
  OPT_wrapper = 2007,                        /* -wrapper */
  OPT_x = 2008,                              /* -x */
  OPT_z = 2009,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
